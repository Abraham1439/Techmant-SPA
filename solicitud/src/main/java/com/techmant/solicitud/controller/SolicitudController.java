...
public class SolicitudController {
    ...
    @Operation(
        ...
        description = "Registra una nueva solicitud de servicio técnico."
    )
    @ApiResponses(value = {
    ...
    public ResponseEntity<Solicitud> crearSolicitud(@RequestBody Solicitud solicitud) {
      ...
      @Operation(
        ...
        description = "Devuelve una lista con todas las solicitudes registradas."
    )
    ...
    @Operation(
        ...
        description = "Devuelve los datos de una solicitud específica según su ID."
    )
    @ApiResponses(value = {
    ...
    @Operation(
        ...
        description = "Modifica una solicitud existente según su ID."
    )
    @ApiResponses(value = {
    ...
    @Operation(
        ...
        description = "Elimina una solicitud de la base de datos según su ID."
    )
    @ApiResponses(value = {
